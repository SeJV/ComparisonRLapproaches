...
Testing contains 4000 episodes of training per agent.  
...
stats = train_agents(env, [dqn_agent_low, dqn_agent_mid, dqn_agent_high],
                     training_episodes=training_episodes, repetitions=1, max_step_per_episode=230)
